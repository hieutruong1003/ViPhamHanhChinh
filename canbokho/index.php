	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<div class="profile-sidebar">
			...
			<div class="profile-usertitle">
				<div class="profile-usertitle-name">Cán Bộ Kho</div>
        ...
        <!-- Start Menu  -->
		<ul class="nav menu">
            <li><a href="danhsachtangvat.html"><em class="glyphicon glyphicon-list-alt">&nbsp;</em> Danh Sách Tang Vật</a></li>
            <li ><a href="nhantangvat.html"><em class="glyphicon glyphicon-plus">&nbsp;</em> Nhận Tang Vật</a></li>
            <li class="active"><a href="index.php"><em class="fa fa-user">&nbsp;</em> Thông Tin Cá Nhân </a></li>
            <li><a href="xemthongtinhoso.html"><em class="glyphicon glyphicon-credit-card"></em> Thông Tin Hồ Sơ </a></li>
					...
					<div class="panel-body">
						...
						<div class="panel panel-default">
                            ...
                            <div class="panel-footer">
                                <button type="button" class="btn btn-link " data-toggle="modalMatKhau" data-target="#myModalMatKhau">
                                    Quên Mật Khẩu
                                    <!-- The Modal Quên Mật Khẩu-->
