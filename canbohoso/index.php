...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <!-- Start Menu  -->
		<ul class="nav menu">
            <li class="active"><a href= "thongtincanhan.html"><em class="fa far fa-user">&nbsp;</em>  Thông Tin Cá Nhân </a></li>
            <li ><a href= "taohosovipham.php"><em class="glyphicon glyphicon-list-alt">&nbsp;</em> Tạo Hồ Sơ Vi Phạm</a></li>
